...
async def list_capabilities() -> str:
    ...
    return (
        ...
        "\n"
        "### Applications\n"
        "- **Create** new applications with name and description\n"
        "- **Update** application name or description\n"
        "- **Delete** applications (with all projects, tasks, and documents)\n"
        "- **Manage members**: add, update roles, or remove application members\n"
        "\n"
        "### Projects\n"
        ...
        "- **Browse** application and project structures\n"
