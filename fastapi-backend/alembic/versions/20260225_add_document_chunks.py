...
def upgrade() -> None:
    ...
    op.execute('ALTER TABLE "DocumentChunks" ADD COLUMN embedding vector(1536)')
    ...
    op.execute('CREATE UNIQUE INDEX idx_document_chunks_doc_idx ON "DocumentChunks" (document_id, chunk_index)')
