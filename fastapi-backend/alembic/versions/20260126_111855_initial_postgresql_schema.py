...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        "fk_Projects_derived_status_id", "Projects", "TaskStatuses", ["derived_status_id"], ["id"], ondelete="SET NULL"
    )
    op.create_foreign_key(
    ...
    op.create_index(
        "ix_invitations_app_invitee_status", "Invitations", ["application_id", "invitee_id", "status"], unique=False
    )
    op.create_index(
        "ix_invitations_invitee_status_created", "Invitations", ["invitee_id", "status", "created_at"], unique=False
    )
    op.create_index(
        "ix_invitations_inviter_status_created", "Invitations", ["inviter_id", "status", "created_at"], unique=False
    )
    op.create_table(
        "Notes",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_ApplicationMembers_application_id"), "ApplicationMembers", ["application_id"], unique=False
    )
