...
must_haves:
  ...
  artifacts:
    ...
    - path: "fastapi-backend/app/services/document_service.py"
      provides: "Document business logic (cursor pagination, scope validation)"
      contains: "async def"
  key_links:
...
<task type="auto">
  <name>Task 2: Create Pydantic schemas, CRUD endpoints for documents and folders</name>
  <files>
